...
CREATE TABLE `pessoa` (
  ...
  `pes_dtnascimento` DATE DEFAULT NULL,
...
CREATE TABLE `telefone` (
  ...
  `ord_numero` varchar(15) DEFAULT NULL,
  `ord_operadora` char(2) DEFAULT NULL,
  `pes_codigo` int DEFAULT NULL,
  PRIMARY KEY (`ord_codigo`),
  KEY `fk_pessoa_idx` (`pes_codigo`),
  CONSTRAINT `fk_pessoa_idx` FOREIGN KEY (`pes_codigo`) REFERENCES `pessoa` (`pes_codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;


INSERT INTO pessoas(`pes_nome`,`pes_apelido`, `pes_sexo`, `pes_dtnascimento`)
VALUES ('Diana Prince','Mulher Maravilha','F','1941-10-21'),
	     ('Bruce Wayne','Batman','M','1934-04-17'),
	     ('Clark Kent','Superman','M','1938-05-19');

INSERT INTO `telefones` (`ord_tipo`, `ord_marca`, `ord_numero`, `ord_operadora`,`pes_codigo`)
VALUES ('Celular','Aple','16992996652','Claro',1),
       ('Celular','Samsung','16995461234','Vivo',3),
	     ('Telefone','Sony','1637225544','CTBC',2);
